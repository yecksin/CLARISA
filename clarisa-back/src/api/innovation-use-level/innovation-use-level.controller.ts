...
export class InnovationUseLevelController {
  constructor(private readonly innovationUseLevelService: InnovationUseLevelService) {}
  ...
  @Patch('update')
  async update(@Res() res: Response, @Body() updateInnovationUseLevelDtoList: UpdateInnovationUseLevelDto[]) {
    try {
      const result : InnovationUseLevel[] = await this.innovationUseLevelService.update(updateInnovationUseLevelDtoList);
