        ...
        "subcategories": [
            {
                ...
                "description": "The list of REST-API services below contains some of the most important general control lists identified by the Management Information Systems during the Annual Reporting process and that can also be used to standardize and provide interoperability across any other CGIAR platforms.",
                "subcategories": [],
                "endpoints": [
                    {
                        "id": 1,
                        "name": "CGIAR entities",
                        "description": "This list contains the official list of CGIAR Centers, CGIAR Research Programs (CRPs), and CGIAR Platforms (PTFs). It also contains the list of Entities that are no longer active now.",
                        "route": "api/cgiar-entities",
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"code\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"Code\", \"object_type\": \"field\", \"show_in_table\": true}, \"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}, \"acronym\": {\"type\": \"string\", \"order\": 2, \"properties\": null, \"column_name\": \"Acronym\", \"object_type\": \"field\", \"show_in_table\": true}, \"cgiarEntityTypeDTO\": {\"type\": \"cgiarEntityTypeDTO\", \"order\": 3, \"properties\": {\"code\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"Code\", \"object_type\": \"field\", \"show_in_table\": true}, \"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}}, \"column_name\": \"CGIAR Entity type\", \"object_type\": \"object\", \"show_in_table\": true}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    },
                    {
                        "id": 2,
                        "name": "CGIAR entities Types",
                        "description": "This list contains the types of entities we have currently in the CGIAR. So far, we have the CGIAR Research Programs, platforms, and Centers.",
                        "route": "api/cgiar-entity-types",
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"code\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"Code\", \"object_type\": \"field\", \"show_in_table\": true}, \"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    },
                    {
                        "id": 3,
                        "name": "Countries",
                        "description": "This list contains all the countries and is following the ISO-3166 standard. The data includes the country names in English, alpha-2 code, and the associated Region according to the UN49 standard.",
                        "route": "api/countries",
                        "http_method": "GET",
                        "request_json": "null",
                    ...
                    },
                    {
                        "id": 4,
                        "name": "UN Regions",
                        "description": "According to the One CGIAR Strategy, the CGIAR works in six regions: Central and West Asia and North Africa, Latin America and the Caribbean, West and Central Africa, East and Southern Africa, South Asia, Southeast Asia, and Pacific",
                        "route": "api/un-regions",
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}, \"um49Code\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"UN49 Code\", \"object_type\": \"field\", \"show_in_table\": true}, \"parentRegion\": {\"type\": \"parentRegion\", \"order\": null, \"properties\": {\"name\": {\"type\": \"string\", \"order\": null, \"properties\": null, \"column_name\": null, \"object_type\": \"field\", \"show_in_table\": false}, \"um49Code\": {\"type\": \"number\", \"order\": null, \"properties\": null, \"column_name\": null, \"object_type\": \"field\", \"show_in_table\": false}}, \"column_name\": null, \"object_type\": \"object\", \"show_in_table\": false}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    },
                    {
                        "id": 5,
                    ...
                    },
                    {
                        ...
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"term\": {\"type\": \"string\", \"order\": 0, \"properties\": null, \"column_name\": \"Term\", \"object_type\": \"field\", \"show_in_table\": true}, \"definition\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Definition\", \"object_type\": \"field\", \"show_in_table\": true}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    }
                ]
            },
            {
                ...
                "endpoints": [
                    {
                        ...
                        "description": "This is a worldwide list of institutions that have been related to CGIAR activities as funders, leaders, partners, and/or contributors. This list reflects the information consolidated by some of the CGIAR Management Information Systems and external sources (i.e. MARLO and MEL).",
                ...
                "endpoints": [
                    {
                        ...
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"id\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"Code\", \"object_type\": \"field\", \"show_in_table\": true}, \"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    },
                    {
                        "id": 24,
            ...
            },
            {
                ...
                "endpoints": [
                    ...
                    },
                    {
                        ...
                        "http_method": "GET",
                        "request_json": "null",
                        "response_json": "{\"type\": \"response\", \"order\": null, \"properties\": {\"id\": {\"type\": \"number\", \"order\": 0, \"properties\": null, \"column_name\": \"ID\", \"object_type\": \"field\", \"show_in_table\": true}, \"name\": {\"type\": \"string\", \"order\": 1, \"properties\": null, \"column_name\": \"Name\", \"object_type\": \"field\", \"show_in_table\": true}}, \"column_name\": null, \"object_type\": \"list\", \"show_in_table\": false}"
                    }
                ]
            },
            {
